            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Data Prosedur Belanja</li>
                    </ol>
                </section>
...
<!--start: Container -->
  ...
  <!-- Main row -->
                    ...
                    <?php
                    $query1="select * from alur_belanja";
                  ...
                  <thead>
                    ...
                    <tbody>
                    <tr>
                    <td><center><?php echo $data['id_belanja'];?></center></td>
                    ...
                    <td><center><div id="thanks"> 
                        <a onclick="return confirm ('Yakin hapus <?php echo $data['keterangan'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Keterangan" href="hapus-content4.php?hal=hapus&kd=<?php echo $data['id_belanja'];?>"><span class="glyphicon glyphicon-trash"></a></center></td></tr></div>
                 <?php   
              } 
              ?>
                   </tbody>
