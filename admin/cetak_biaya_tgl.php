...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../assets2/plugin/jquery-ui/jquery-ui.min.css" /> <!-- Load file css jquery-ui -->
        <script src="../assets2/js/jquery.min.js"></script>

         <!-- FONTAWESOME STYLES-->
    <link href="../assets1/css1/font-awesome.css" rel="stylesheet" />
        <!-- CUSTOM STYLES-->
    <link href="../assets1/css1/custom.css" rel="stylesheet" />
     <!-- GOOGLE FONTS-->
  ...
  <div class="col-lg-6 col-xs-10">
    ...
    <form method="get" action="">
        ...
        <div id="form-tahun">
            ...
            <select name="tahun">
                <option value="">Pilih</option>
                <?php
                $query = "SELECT YEAR(tanggal) AS tahun FROM konfirmasi GROUP BY YEAR(tanggal)"; // Tampilkan tahun sesuai di tabel transaksi
       ...
       <a href="laporan_ongkir.php" class="btn btn-sm btn-danger"><b>Batal </b></a>
        <a href="cetak_biaya_tgl.php">Reset Filter</a>
    </form>
    <hr />
    ...
    if(isset($_GET['filter']) && ! empty($_GET['filter'])){ // Cek apakah user telah memilih filter dan klik tombol tampilkan
        ...
        if($filter == '1'){ // Jika filter nya 1 (per tanggal)
            ...
            echo '<a href="print3.php?filter=1&tanggal='.$_GET['tanggal'].'">Cetak PDF</a><br /><br />';
            ...
            echo '<a href="print3.php?filter=2&bulan='.$_GET['bulan'].'&tahun='.$_GET['tahun'].'">Cetak PDF</a><br /><br />';
            ...
            echo '<a href="print3.php?filter=3&tahun='.$_GET['tahun'].'">Cetak PDF</a><br /><br />';
