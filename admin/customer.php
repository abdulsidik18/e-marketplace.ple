        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
			...
			?>
              ...
              <form action='customer.php' method="POST">
                  ...
                  <a href="input-customer.php" class="btn btn-sm btn-warning">Tambah Pelanggan <i class="fa fa-arrow-circle-right"></i></a>
          ...
          ?>
                    ...
                    <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Pelanggan" href="edit-customer.php?hal=edit&kd_cus=<?php echo $data['kd_cus'];?>"><span class="glyphicon glyphicon-edit"></span></a>  
                    <a onclick="return confirm ('Yakin hapus <?php echo $data['nama'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Pelanggan" href="customer.php?hal=hapus&kd=<?php echo $data['kd_cus'];?>"><span class="glyphicon glyphicon-trash"></a></center></td></tr></div>
                 <?php   
              } 
              ?>
                   </tbody>
