        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
             ...
             if(isset($_GET['hal']) == 'hapus'){
				$kode = $_GET['kd'];
				$cek = mysqli_query($koneksi, "SELECT * FROM desa WHERE id_desa='$kode'");
				if(mysqli_num_rows($cek) == 0){
					echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data tidak ditemukan.</div>';
				}else{
					$delete = mysqli_query($koneksi, "DELETE FROM desa WHERE id_desa='$kode'");
					if($delete){
			...
			?>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Data Alamat</a></li>
                        <li class="active">Data Alamat</li>
                    </ol>
                </section>
	     ...
	     <!--  <input type='text' class="form-control" style="margin-bottom: 4px;" name='qcari' placeholder='Cari Nama Desa atau Biaya' required /> 
           <input type='submit' value='Cari Data Desa' class="btn btn-sm btn-primary" /> <a href='kecamatan.php' class="btn btn-sm btn-success" >Refresh</i></a>-->
             <a href="input-desa.php" class="btn btn-sm btn-warning">Tambah Alamat <i class="fa fa-arrow-circle-right"></i></a>
          	</div>
              </div>
           <!-- /.row -->
                    <br />
                    ...
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Data Alamat</h3> 
                        </div>
	               ...
	               $qcari=$_POST['qcari'];
	               $query1="SELECT * FROM  desa 
	               where nama_desa like '%$qcari%'
	               or biaya_kirim like '%$qcari%'  ";
                    }
                  ...
                  <thead>
                      <tr>
                        <th><center>No </center></th>
                         <th><center>Nama Alamat </i></center></th>
                       ...
                       <?php 
          $query = mysql_query("SELECT * FROM desa");
          $no = 1;
          ...
          ?>
                    ...
                    <td><center>Rp. <?php echo $data ['biaya_kirim']; ?></center></td>
                  
                    <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Desa" href="edit-desa.php?hal=edit&kode=<?php echo $data['id_desa'];?>"><span class="glyphicon glyphicon-edit"></span></a>  
                    <a onclick="return confirm ('Yakin hapus <?php echo $data['nama_desa'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Desa" href="desa.php?hal=hapus&kd=<?php echo $data['id_desa'];?>"><span class="glyphicon glyphicon-trash"></a></center></td></tr></div>
                 <?php   
              } 
              ?>
                   </tbody>
