                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-customer.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="kd_cust" type="text" id="kd_cust" value="<?php echo $row['kd_cus']; ?>" class="form-control" autocomplete="off" placeholder="Auto Number Tidak perlu di isi" style="width: 136px;" />
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="e_mail" type="text" id="no_ktp" value="<?php echo $row['e_mail']; ?>" class="form-control" autocomplete="off" placeholder="e_mail" readonly="readonly" autocomplete="off" required style="width: 288px;"/>
                            </div>
                          </div>
                          <div class="form-group">
