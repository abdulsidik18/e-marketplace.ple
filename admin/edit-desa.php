...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Alamat Account</li>
                    </ol>
                </section>
                ...
                <?php
            $kd = $_GET['kode'];
			$sql = mysqli_query($koneksi, "SELECT * FROM desa WHERE id_desa='$kd'");
			...
			if(isset($_POST['update'])){
				...
				$update = mysqli_query($koneksi, "UPDATE desa SET nama_desa='$nama_desa', biaya_kirim='$biaya_kirim' WHERE id_desa='$id_desa'") or die(mysqli_error());
				if($update){
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Edit Alamat </h3> 
                        </div>
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="id_desa" type="text" id="id_desa" value="<?php echo $row['id_desa']; ?>" class="form-control" autocomplete="off" readonly="readonly">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Alamat</label>
                              <div class="col-sm-3">
                            <input name="nama_desa" type="text" id="nama_desa" value="<?php echo $row['nama_desa']; ?>" class="form-control" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="biaya_kirim" type="text" id="biaya_kirim" value="<?php echo $row['biaya_kirim']; ?>" class="form-control" required />
