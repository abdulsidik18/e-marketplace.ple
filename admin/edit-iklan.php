...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <?php
           $kd = $_GET['kode'];
			$sql = mysqli_query($koneksi, "SELECT * FROM iklan WHERE kode='$kd'");
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Edit Data Iklan </h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-iklan.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="jenis" type="text" id="jenis" value="<?php echo $row['jenis']; ?>" class="form-control" autocomplete="off" placeholder="Nama Produk" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="nama_file" type="file" id="nama_file" class="form-control" required /></input>
                            </div>
                          </div>
