                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-po-terima.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="id" type="text" id="id" value="<?php echo $row['id']; ?>" class="form-control" autocomplete="off" placeholder="Auto Number Tidak perlu di isi" readonly="readonly" style="width: 106px"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No PO</label>
                              <div class="col-sm-3">
                            <input name="nopo" type="text" id="nopo" value="<?php echo $row['nopo']; ?>" class="form-control" autocomplete="off" readonly="readonly" style="width: 206px"/>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="kd_cus" type="text" id="kd_cus" value="<?php echo $row['kd_cus']; ?>" class="form-control" autocomplete="off" readonly="readonly" style="width: 206px" />
                          ...
                          <div class="form-group">
                            ...
                            <select id="size" name="size" class="form-control" required style="width: 91px">
                            ...
                            <label class="col-sm-2 col-sm-2 control-label">Ukuran Sebelumnya</label>
                              <div class="col-sm-3">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input type="text" class="form-control" id="qty" name="qty" value="<?php echo $row['qty']; ?>" readonly="readonly" style="width: 114px"/>
                            </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Total</label>
                              <div class="col-sm-3">
                            <input type="text" class="form-control" id="total" name="total" value="<?php echo $row['total']; ?>" readonly="readonly" style="width: 114px"/>
                            </div>
                          </div>
                          <div class="form-group">
