        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i>Data PO </h3> 
                        </div>
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-po.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="color" type="text" id="color" value="<?php echo $row['color']; ?>" class="form-control" autocomplete="off" required style="width: 206px"/>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <select id="size" name="size" class="form-control" required style="width: 146px">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input type="text" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" id="tanggalkirim" name="tanggalkirim" required style="width: 96px"/>
                            </div>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tanggal Terima</label>
                              <div class="col-sm-3">
                            <input type="text" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" id="tanggalexport" name="tanggalexport" required style="width: 96px"/>
                            </div>
                            <label class="col-sm-2 col-sm-2 control-label">Tanggal Terima Sebelumnya</label>
                              <div class="col-sm-3">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <select id="status" name="status" class="form-control" required style="width: 246px"/>
