...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <?php
           $kd = $_GET['id'];
			$sql = mysqli_query($koneksi, "SELECT * FROM profil WHERE id='$kd'");
           ...
           <!-- /.row -->
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-profil.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="content" type="text" id="content" value="<?php echo $row['content']; ?>" class="form-control" autocomplete="off" placeholder="Isi content" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="created" type="text" id="created" value="<?php echo $row['created']; ?>" class="form-control" autocomplete="off" placeholder="Tangga/Jam" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
	                              ...
	                              <a href="Profil_toko.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
                      </form>
                  </div>
