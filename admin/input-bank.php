            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Masukan Data Bank Account</li>
                    </ol>
                </section>
	...
	echo "Anda belum memilih gambar";
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Masukan Data Bank </h3> 
                        </div>
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-bank.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                              <input name="id_bank" type="text" id="id_bank" class="form-control" autocomplete="off" placeholder="Auto Number Tidak perlu di isi" readonly="readonly" style="width: 216px"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Bank</label>
                              <div class="col-sm-3">
                            <input name="nama_bank" type="text" id="nama_bank" class="form-control" autocomplete="off" placeholder="Nama Bank" autocomplete="off" required style="width: 326px"/>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="no_rek" type="text" id="no_rek" class="form-control" autocomplete="off" placeholder="No Rekening" autocomplete="off" required style="width: 326px"/>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="nasabah" type="text" id="nasabah" class="form-control" autocomplete="off" placeholder="Nasabah" autocomplete="off" required style="width: 426px"/>
