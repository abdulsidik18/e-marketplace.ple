            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Masukan Data Pelanggan</li>
                    </ol>
                </section>
...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	$jenis_gambar=$_FILES['nama_file']['type'];
        ...
        $cekno= mysqli_query($koneksi, "SELECT * FROM pelanggan ORDER BY kd_cus DESC");
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="INSERT INTO customer(kd_cus,nama,alamat,no_ktp,no_telp,e_mail,username,password,gambar) VALUES
            ('$kode','$nama','$alamat','$no_ktp','$no_telp','$e_mail','$username','$password','$gambar')";
	...
	echo "Anda belum memilih gambar";
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Masukan Data Pelanggan </h3> 
                        </div>
                      ...
                      <form class="form-horizontal style-form" action="input-customer.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="no_ktp" type="text" id="no_ktp" class="form-control" autocomplete="off" placeholder="NIK Customer" autocomplete="off" required />
                          ...
                          <div class="form-group">
                            ...
                            <input name="no_telp" type="text" id="no_telp" class="form-control" autocomplete="off" placeholder="No Telepon" autocomplete="off" required />
                             ...
                             <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="e_mail" type="text" id="e_mail" class="form-control" autocomplete="off" placeholder="Email Customer" autocomplete="off" required />
