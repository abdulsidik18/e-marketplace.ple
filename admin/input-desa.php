            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Masukan Data Alamat</li>
                    </ol>
                </section>
...
<?php
			if(isset($_POST['input'])){
				...
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($koneksi, "INSERT INTO desa (nama_desa, ongkos_kirim)
															VALUES('$nama_desa','$ongkos_kirim')") or die(mysqli_error());
						if($insert){
	...
	echo "Anda belum memilih gambar";
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Masukan Data Alamat </h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-desa.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Id Alamat</label>
                              <div class="col-sm-8">
                              <input name="id_Desa" type="text" id="id_kecamatan" class="form-control" autocomplete="off" placeholder="Auto Number Tidak perlu di isi" readonly="readonly"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Alamat</label>
                              <div class="col-sm-3">
                            <input name="nama_desa" type="text" id="nama_desa" class="form-control" autocomplete="off" placeholder="Nama Alamat" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="ongkos_kirim" type="text" id="ongkos_kirim" class="form-control" autocomplete="off" placeholder="Biaya" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
	                              ...
	                              <a href="desa.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
                      </form>
                  </div>
