            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Masukan Data Iklan</li>
                    </ol>
                </section>
...
$namafolder="gambar_iklan/"; //tempat menyimpan file
...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
  ...
  {     
    ...
    if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
      $sql="INSERT INTO iklan(kode,nama,jenis,keterangan,gambar) VALUES
            ('$kode','$nama','$jenis','$keterangan','$gambar')";
      $res=mysqli_query($koneksi, $sql) or die (mysqli_error());
      //echo "Gambar berhasil dikirim ke direktori".$gambar;
            echo "<script>alert('Data Iklan berhasil dimasukan!'); window.location = 'iklan.php'</script>";    
    } else {
      ...
      ?>
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Masukan Data Iklan </h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-iklan.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kode Iklan</label>
                              <div class="col-sm-8">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="nama" type="text" id="nama" class="form-control" autocomplete="off" placeholder="Nama Perusahaan" autocomplete="off" required />
                              
                            </div>
                          </div>
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jenis Iklan</label>
                              <div class="col-sm-3">
                            <input name="jenis" type="text" id="jenis" class="form-control" autocomplete="off" placeholder="jenis" autocomplete="off" required />
                            </div>
                          </div>
                         <div class="form-group">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Gambar Iklan</label>
                              <div class="col-sm-3">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                ...
                                <a href="iklan.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
                      </form>
                  </div>
