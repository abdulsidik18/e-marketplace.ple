            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Masukan Data PO Kirim</li>
                    </ol>
                </section>
...
<?php
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Masukan Data PO Kirim </h3> 
                        </div>
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="insert-po-kirim.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="color" type="text" id="color" value="<?php echo $row['color']; ?>" class="form-control" autocomplete="off"  readonly="readonly" />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="size" type="text" id="size" value="<?php echo $row['size']; ?>" class="form-control" autocomplete="off"  readonly="readonly" />
