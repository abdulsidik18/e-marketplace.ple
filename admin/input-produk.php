            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Masukan Data Produk</li>
                    </ol>
                </section>
...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="INSERT INTO produk(kode,nama,jenis,harga,keterangan,stok,gambar,tanggal) VALUES
            ('$kode','$nama','$jenis','$harga','$keterangan','$stok','$gambar','$tanggal')";
	...
	echo "Anda belum memilih gambar";
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Masukan Data Produk </h3> 
                        </div>
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-produk.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="kode" type="text" id="kode" class="form-control" autocomplete="off" placeholder="Auto Number Tidak perlu di isi" readonly="readonly" style="width: 206px"/>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama Produk</label>
                              <div class="col-sm-3">
                            <input name="nama" type="text" id="nama" class="form-control" autocomplete="off" placeholder="Nama Produk" autocomplete="off" required style="width: 276px"/>
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Jenis</label>
							    <div class="col-sm-3">
                            <select id="jenis" name="jenis" class="form-control" required style="width: 206px">
                            <option value="flori">Florikultura</option>
                            <option value="utility">Peralatan</option>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="harga" type="text" id="harga" class="form-control" autocomplete="off" placeholder="Harga Produk" autocomplete="off" required style="width: 206px"/>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <textarea name="keterangan" type="text" id="keterangan" class="form-control" autocomplete="off" placeholder="Keterangan" autocomplete="off" required style="width: 326px"/></textarea>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="stok" type="text" id="stok" class="form-control" autocomplete="off" placeholder="Stock Produk" autocomplete="off" required style="width: 106px"/>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="nama_file" type="file" id="nama_file" class="form-control" required style="width: 266px"/>
