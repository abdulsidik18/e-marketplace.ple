...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            ?>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Biaya Kirim</a></li>
              ...
              <form action='konfirmasi.php' method="POST">
                 ...
                 <a href='cetak_biaya_tgl.php' class="btn btn-sm btn-warning" >Cetak Per Periode</i></a>
             <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Cetak Biaya" href="cetak-biaya.php?hal=cetak&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-print"></span></a> 
           ...
           <!-- /.row -->
                    ...
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-cart-plus"></i> Laporan Biaya Kirim Produk </h3> 
                        </div>
