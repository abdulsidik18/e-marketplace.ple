  ...
  <div class="col-lg-6 col-xs-10">
    ...
    <div class="box box-Default"> 
        ...
        <div class="box-body">
	      ...
	      <!-- <input type='text' class="form-control" style="margin-bottom: 4px;" name='qcari' placeholder='Cari Nama Produk & Jenis Produk' required /> 
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='list_produk.php' class="btn btn-sm btn-success" >Refresh</i></a>-->
            <a href='cetak_produk.php' class="btn btn-sm btn-warning" >Cetak Per Periode</i></a>
             <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Cetak Produk" href="cetak-produk.php?hal=cetak&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-print"></span></a> 
           ...
           <!-- /.row -->
                  ...
                  <thead>
                      <tr>
                        ...
                        <th><center>Keterangan </i></center></th>
