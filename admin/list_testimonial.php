...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
              ...
              <div class="col-lg-4">
              <form action='list_testimonial.php' method="POST">
          
	       <!--<input type='text' class="form-control" style="margin-bottom: 4px;" name='qcari' placeholder='Cari berdasarkan Nama' required /> 
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='list_testimonial.php' class="btn btn-sm btn-success" >Refresh</i></a>-->
          	</div>
              </div>
           <!-- /.row -->
                    <br />
                    ...
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Data Testimonial </h3> 
                        </div>
          ...
          ?>
                    ...
                    <td><center><div id="thanks">
                        <a onclick="return confirm ('Yakin hapus <?php echo $data['nama'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Admin" href="hapus-testimonial.php?hal=hapus&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-trash"></a></center></td></tr></div>
                 <?php   
              } 
              ?>
                   </tbody>
