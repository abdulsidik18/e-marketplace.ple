...
<html>
    <head>
        ...
        <link href="../assets1/css1/bootstrap.css" rel="stylesheet" />
     <!-- FONTAWESOME STYLES-->
  ...
  <div class="col-lg-6 col-xs-10">
    ...
    <form method="get" action="">
        ...
        <div id="form-tahun">
            ...
            <select name="tahun">
                <option value="">Pilih</option>
                <?php
                $query = "SELECT YEAR(tanggal) AS tahun FROM konfirmasi  GROUP BY YEAR(tanggal)";
       ...
       <a href="po-report.php" class="btn btn-sm btn-danger"><b>Batal </b></a>
        <a href="po-report-tgl.php">Reset Filter</a>
    </form>
    <hr />
    ...
    ?>
       ...
       <div class="box-body">
        ...
        <th><center>Bayar Via</center></th>
        <th><center>Biaya Kirim</center></th>
