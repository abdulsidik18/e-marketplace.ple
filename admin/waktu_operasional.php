...
<!--start: Container -->
  ...
  <!-- Main row -->
                    ...
                    <?php
                    $query1="select * from waktu_operasional";
                  ...
                  <thead>
                    ...
                    <tbody>
                    <tr>
                    <td><center><?php echo $data['id_waktu'];?></center></td>
                    ...
                    <td><center><div id="thanks"> 
                        <a onclick="return confirm ('Yakin hapus <?php echo $data['keterangan'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Keterangan" href="hapus-content1.php?hal=hapus&kd=<?php echo $data['id_waktu'];?>"><span class="glyphicon glyphicon-trash"></a></center></td></tr></div>
                 <?php   
              } 
              ?>
                   </tbody>
