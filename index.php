...
<head>
	...
	<link type="text/css" rel="stylesheet" href="ikon_dock.css">
...
<?php
		...
		$res = $koneksi->query("SELECT * FROM editor ORDER BY id DESC LIMIT 5") or die($koneksi->error);
    ...
    height: 250px;"/></a></style>
					...
					<!--	<p>
						...
						<div class="clear"><a href="detailproduk.php?kd=<?php echo $data['kode'];?>" class="btn btn-lg btn-danger">Details</a> <a href="detailproduk.php?kd=<?php echo $data['kode'];?>" class="clear"> <a href="index.html" class="btn btn-lg btn-success">Beli &raquo;</a></div>
...
<!---->
	...
	<!--<div class="box" style="margin-left:1100px; top:150px">-->
