...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <?php
            $kd = $_GET['kode'];
			$sql = mysqli_query($koneksi, "SELECT * FROM konfirmasi1 WHERE id_kon='$kd'");
			if(mysqli_num_rows($sql) == 0){
				header("Location: konfirmasi1.php");
			}else{
           ...
           <!-- /.row -->
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-konfirmasi1.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
