...
$total=mysqli_query($connection, "SELECT * FROM konfirmasi");
...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <?php
            $kd = $_GET['kode'];
			$sql = mysqli_query($koneksi, "SELECT * FROM po_terima1 WHERE id='$kd'");
            
			if(mysqli_num_rows($sql) == 0){
				header("Location: po-terima1.php");
			}else{
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> PO Terima</h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-po-terima1.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kode</label>
                              <div class="col-sm-8">
                                  <input name="id" type="text" id="id" value="<?php echo $row['id']; ?>" class="form-control" autocomplete="off" placeholder="Auto Number Tidak perlu di isi" readonly="readonly" style="width:116px;/">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">No PO</label>
                              <div class="col-sm-3">
                            <input name="nopo" type="text" id="nopo" value="<?php echo $row['nopo']; ?>" class="form-control" autocomplete="off" readonly="readonly" style="width:166px;/">
                              
                            </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pelanggan</label>
                              <div class="col-sm-3">
                            <input name="kd_cus" type="text" id="kd_cus" value="<?php echo $row['kd_cus']; ?>" class="form-control" autocomplete="off" readonly="readonly" style="width:166px;" />
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kode</label>
                              <div class="col-sm-3">
                            <input name="kode" type="text" id="kode" value="<?php echo $row['kode']; ?>" class="form-control" autocomplete="off" readonly="readonly" style="width:56px;"/>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="tanggal" type="text" id="tanggal" value="<?php echo $row['tanggal']; ?>" class="form-control" autocomplete="off" readonly="readonly" style="width:146px;"/>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="color" type="text" id="color" value="<?php echo $row['color']; ?>" class="form-control" autocomplete="off" required style="width:106px;"/>
                          ...
                          <div class="form-group">
                            ...
                            <select id="size" name="size" class="form-control" required style="width:96px;"/>
                            ...
                            <label class="col-sm-2 col-sm-2 control-label" style="width: 155px;">Ukuran Sebelumnya</label>
                              <div class="col-sm-3">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input type="text" class="form-control" id="qty" name="qty" value="<?php echo $row['qty']; ?>" readonly="readonly" style="width:84px;" />
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <input type="text" class="form-control" id="total" name="total" value="<?php echo $row['total']; ?>" readonly="readonly" style="width:84px;"/>
