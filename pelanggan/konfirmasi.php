        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
          ...
          ?>
                    ...
                    <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit Konfirmasi" href="edit-konfirmasi.php?hal=edit&kode=<?php echo $data['id_kon'];?>"><span class="glyphicon glyphicon-edit"></span></a> 
                     <a onclick="return confirm ('Yakin hapus Pembayaran <?php echo $data['id_kon'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Pembayaran" href="konfirmasi.php?hal=hapus&kd=<?php echo $data['id_kon'];?>"><span class="glyphicon glyphicon-trash"></a> 
                    </center></td></tr></div>
                 <?php   
              } 
              ?>
