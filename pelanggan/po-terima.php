...
<?php } ?>
 ...
 <div class="row">
             ...
             if(isset($_GET['hal']) == 'hapus'){
                ...
                if(mysqli_num_rows($cek) == 0){
                    ...
                    if($delete){
                        echo '<div class="alert alert-info" role="alert"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data berhasil dihapus.</div>';
                    }else{
                        echo '<div class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data gagal dihapus.</div>';
                    }
                }
            }
            ?>
               ...
               <table class="table table-bordered table-hover datatab">
                  <thead>
                    ...
                    <td><center><div id="thanks"><a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="Detail Pembayaran" href="detail-konfirmasi1.php?hal=detail&kd=<?php echo $data2['id_kon'];?>"><span class="glyphicon glyphicon-search"></span></a> 
                    ...
                    <a onclick="return confirm ('Yakin hapus Pembayaran <?php echo $data2['id_kon'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus Pembayaran" href="po-terima.php?hal=hapus&kd=<?php echo $data2['id_kon'];?>"><span class="glyphicon glyphicon-trash"></span></a>
 ...
 <section class="col-lg-12 connectedSortable"> 
                        ...
                        <div class="panel-heading">
                        <h3 class="panel-title"><span class="glyphicon glyphicon-tag"></span>Data PO Terima  </h3> 
                        </div>
                        <div class="panel-body">
                        <div class="col-lg-12">
                        <?php
             if(isset($_GET['hal']) == 'hapus'){
                ...
                if(mysqli_num_rows($cek) == 0){
                    ...
                    if($delete){
                        ...
                        echo '<div class="class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data gagal dihapus.</div>';
                    }
                }
            }
            ...
            ?>
                  ...
                  <thead>
                      <tr>
                        ...
                        <th><center>Total Barang </center></th>
                        <th><center>Tools </center></th>
                      </tr>
                  </thead>
                    <tbody>
          ...
          <td><center><?php echo $no++; ?></center></td>
                    ...
                    <a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit PO Terima" href="edit-po-terima1.php?hal=edit&kode=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-edit"></span></a>  
                    <a onclick="return confirm ('Yakin hapus PO <?php echo $data['id'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus PO Terima" href="po-terima.php?hal=hapus&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-trash"></span></a></center></td></tr></div>
