...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="INSERT INTO konfirmasi (id_kon, nopo, kd_cus, bayar_via, nama_desa, biaya_kirim, tanggal, jumlah, total, status) VALUES
            ('$id_kon','$nopo','$kd_cus','$bayar_via','$nama_desa','$biaya_kirim','$tanggal','$jumlah','$total','$a')";
